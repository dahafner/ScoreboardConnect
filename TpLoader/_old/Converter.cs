...
namespace TP
{
    public class Converter
    {
        ...
        public static Task<List<EventData>> ExtractEvents(System.Data.IDbConnection dbConnection)
        {
            return Task.Run(() =>
            {
        ...
        //private static IntermediateLink CreateLink(PlayerMatchData van, Draw targetDraw, Event e, string teamIdentifier, MatchExtended sbMatch) {
        //if (van.Link == null) {
        //  throw new Exception("PlayerMatch link reference cannot be null when extracting link.");
        //}
        //DrawData sourceDraw = e.Draws.Find(d => d.ID == van.Link.SourceDrawID);
        //if (sourceDraw == null) {
